<div class="home-content">
          <div class="big-content">
            <div class="content">
              <div class="user-interest">
                ...
                <div class="user-interest-btn-container">
              ...
              <div class="next-interest"><button class="bh w iz ap ja jb pn" aria-label="next sections"
              tabindex="0"><svg width="26px" height="26px" class="svgIcon-use" viewBox="0 0 19 19" aria-hidden="true"
          ...
          <!-- <h1>This is when the user has been authenticated</h1> -->
        </div>
...
.user-interest-btn-container button {
...
<div class="section-content">
        <main class="content-item main-page">
          <div st> <h1>wefwefa</h1></div>
          <div class="user-feed-container"></div>
